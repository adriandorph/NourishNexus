...
public class FoodItemSeeding
{
    ...
    {
        _eggsAndBacon = new Recipe("Eggs and Bacon", true, "", "", _author.Id, new List<Category>{_meat}, true, false, false, false);
        _bunsWithStrawberryJam = new Recipe("Buns with Strawberry Jam", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunsWithRaspberryJam = new Recipe("Buns with Raspberry Jam", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunsWithBlackberryJam = new Recipe("Buns with Blackberry Jam", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunsWithRhubarbJam = new Recipe("Buns with Rhubarb Jam", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunsWithCheese = new Recipe("Buns with Cheese", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunsWithPeanutbutter = new Recipe("Buns with Peanutbutter", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunsWithMapleSyrup = new Recipe("Buns with Maple Syrup", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _bunswithSpreadChocolate = new Recipe("Buns with Chocolate Spread", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _QuinoaBowl = new Recipe("Quinoa Bowl", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _OatMealBowl = new Recipe("Oatmeal Bowl", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _OatMealBoiled = new Recipe("Oatmeal Boiled", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        _BreadAndSalmon = new Recipe("Bread and Salmon", true, "", "", _author.Id, new List<Category>{_meat}, true, false, false, true);
        _BreadAndHam = new Recipe("Bread and Ham", true, "", "", _author.Id, new List<Category>{_meat}, true, false, false, true);
        _EggsBaconAndSausages = new Recipe("Eggs with Bacon and Sausages", true, "", "", _author.Id, new List<Category>{_meat}, true, false, false, false);
        _FruitBowl = new Recipe("Fruit bowl", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, true, false, false, true);
        _Cereal = new Recipe("Cornflakes", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, false);
        _pancakes = new Recipe("Pancakes", true, "", "", _author.Id, new List<Category>{_vegetarian}, true, false, false, true);
        
        //Lunch 
        _durumKebab = new Recipe("Durum with Kebab", true, "", "", _author.Id, new List<Category>{_meat}, false, true, true, false);
        _durumChicken = new Recipe("Durum with Chicken", true, "", "", _author.Id, new List<Category>{_meat}, false, true, true, false);
        _durumMix = new Recipe("Durum with Mix", true, "", "", _author.Id, new List<Category>{_meat}, false, true, true, false);
        _mixBox = new Recipe("Mix Box", true, "", "", _author.Id, new List<Category>{_meat}, false, true, true, false);
        _kebabBox = new Recipe("Kebab Box", true, "", "", _author.Id, new List<Category>{_meat}, false, true, true, false);
        _chickenBox = new Recipe("Chicken Box", true, "", "", _author.Id, new List<Category>{_meat}, false, true, true, false);
        _fishFillet = new Recipe("Fish fillets", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, false);
        _ryebreadWithSalmon = new Recipe("Ryebread with Salmon", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, true);
        _ryebreadWithAvocado = new Recipe("Ryebread with Avocado", true, "", "", _author.Id, new List<Category>{_vegetarian}, false, true, false, true);
        _ryebreadPlatte = new Recipe("Ryebread Platte", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, true);
        _grilledToastWithTunaAndPesto = new Recipe("Grilled Toast with Tuna and Pesto", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, true);
        _grilledToastWithHamAndCheese = new Recipe("Grilled Toast with Ham and Cheese", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, true);
        _paninoWithTomatoMozzarellaAndSalami = new Recipe("Panino with Tomato Mozzarella and Salami", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, true);
        _hamAndCheeseSandwich = new Recipe("Ham and Cheese Sandwich", true, "", "", _author.Id, new List<Category>{_meat}, false, true, false, true);
        
        //Dinner
        _risotto = new Recipe("Risotto", true, "Risotto", "Risotto",_author.Id, new List<Category>{_vegetarian},false, false, true, false);
        _pastaCarbonara = new Recipe("Pasta Carbonara", true, "Pasta Carbonara", "Pasta Carbonara", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _butterChicken = new Recipe("Butter Chicken", true, "Butter Chicken", "Butter Chicken", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _chiliConCarne = new Recipe("Chili Con Carne", true, "Chili Con Carne", "Chili Con Carne", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _beefBernaise = new Recipe("Beef Bernaise", true, "Beef Bernaise", "Beef Bernaise", _author.Id, new List<Category>{_meat},false, false, true, false);
        _pastaPuttanesca = new Recipe("Pasta Putanesca", true, "Pasta Putanesca", "Pasta Putanesca", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _pastaTuna = new Recipe("Pasta Tuna", true, "Pasta Tuna", "Pasta Tuna", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _tortillas = new Recipe("Tortillas", true, "Tortillas", "Tortillas", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _meatballsCurry = new Recipe("Meatballs Curry", true, "Meatballs Curry", "Meatballs Curry", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _steakWithPepperSauce = new Recipe("Steak with Pepper Sauce", true, "Steak with Pepper Sauce", "", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _steakWithWhiskeySauce = new Recipe("Steak with Whiskey Sauce", true, "Steak with Whiskey Sauce", "", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _tacos = new Recipe("Tacos", true, "Tacos", "Tacos", _author.Id, new List<Category>{}, false, false, true, false);
        _honeyGarlicFriedPorkChops = new Recipe("Honey-garlic fried pork chops", true,"Honey-garlic fried pork chops", "Honey-garlic fried pork chops", _author.Id, new List<Category>{_meat},false, false, true, false);
        _chickenFriedRice = new Recipe("Chicken Fried Rice", true, "Chicken stir fry", "Chicken stir fry", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _shrimpStirFry = new Recipe("Shrimp stir fry", true, "Shrimp stir fry", "Shrimp stir fry", _author.Id, new List<Category>{_meat},false, false, true, false);
        _springRolls = new Recipe("Spring rolls", true, "Spring rolls", "Spring rolls",_author.Id,new List<Category>{_vegetarian},false, false, true, false);
        _bakedSalmonAndAsparagus = new Recipe("Baked salmon and asparagus", true,"Baked salmon and asparagus", "Baked salmon and asparagus",_author.Id, new List<Category>{_meat}, false, false, true, false);
        _meatLasagna = new Recipe("Meat lasagna", true, "Meat lasagna", "Meat lasagna", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _veganLasagna = new Recipe("Vegan lasagna", true, "Vegan lasagna", "Vegan lasagna", _author.Id, new List<Category>{_vegetarian}, false, false, true, false);
        _lambChopWithPotatoes = new Recipe("Lamb chop with potatoes", true, "Lamb chop with potatoes", "Lamb chop with potatoes", _author.Id, new List<Category>{_meat}, false, false, true, false);
        _frikadellerWithRice = new Recipe ("Frikadeller with rice", true, "Frikadeller with rice", "Frikadeller with rice", _author.Id, new List<Category>{_meat}, false, false, true, false);

        _cashewPeanutNutMix = new Recipe("Cashew Peanut Mix", true, "", "", _author.Id, new List<Category>{_vegetarian}, false, false, false, true);
        _pistachioNutMix = new Recipe("Pistachio Mix", true, "", "", _author.Id, new List<Category>{_vegetarian}, false, false, false, true);
        _almondRaisinMix = new Recipe("Alomnd Raisin Mix", true, "", "", _author.Id, new List<Category>{_vegetarian}, false, false, false, true);
        _pineappleOrangefruitMix = new Recipe("Pineapple Orange Mix", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _appleOrangePearfruitMix = new Recipe("Apple Orange Pear Mix", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _raspberryBlueberryfruitMix = new Recipe("Raspberry Blueberry Mix", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _blackberryStrawberryfruitMix = new Recipe("Blackberry Strawberry Mix", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _strawberryBananaSmoothie = new Recipe("Strawberry Banana Smoothie", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _mangoSmoothie = new Recipe("Mango smoothie", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _blueberrySmoothie = new Recipe("Blueberry smoothie", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _appleCarrotOrangeSmoothie = new Recipe("Apple Carrot Orange smoothie", true, "", "", _author.Id, new List<Category>{_fruit, _vegetarian}, false, false, false, true);
        _peanutbutterSandwich = new Recipe("Peanutbutter sandwich", true, "", "", _author.Id, new List<Category>{_vegetarian}, false, false, false, true);
        _salamiSticks = new Recipe("Salami sticks", true, "", "", _author.Id, new List<Category>{_meat}, false, false, false, true);
        _salamiSticksOlivesAndCheese = new Recipe("Salami sticks olives and cheese", true, "", "", _author.Id, new List<Category>{_meat}, false, false, false, true);
        _crackersWithPesti = new Recipe("Crackers with pesti", true, "", "", _author.Id, new List<Category>{_vegetarian}, false, false, false, true);
